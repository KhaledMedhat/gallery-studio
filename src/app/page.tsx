            ...
            <div className="container mx-auto px-4 text-center">
              <div className="flex flex-col gap-6">
                ...
                <p className="mt-4 text-xl text-muted-foreground">
                  Discover a world of captivating artworks Create your personal
                  gallery, Discover a world of captivating artworks, explore
                  other&apos;s collections, and share your favorite moments.
                  Easily upload your own images and discover stunning visuals
                  from a community of creators. Join and showcase your
                  creativity!
                </p>
              </div>
